...
class User extends CI_Controller{
    ...
    function index()
    {
        ...
        $config['base_url'] = site_url('tb_am_user/index?');
        ...
        if ($this->form_validation->run()) {
            ...
            if (password_verify($old_password, $ancien_password_db)) {
                ...
                //if (!preg_match("/^[a-z0-9_-]{6,75}$/i", $nvo_mot_pass)) {
                    ...
                    if ($this->Educazad_model->update_data('tb_am_users', $data_ut, array('id_asset' => $this->session->id))) {
                        //redirect
    ...
    function updateAccount()
    {
        ...
        $this->form_validation->set_rules('phone', 'phone', 'required|min_length[9]|max_length[9]',
            array(
        ...
        if ($this->form_validation->run()) {
            ...
            if ($this->Educazad_model->update_data('tb_am_users', $userdata,
    ...
    public function uploadPicture()
    {
        ...
        if (!$this->upload->do_upload('userfile')) {
           ...
           $this->setUploadError('Les erreurs suivantes ont ete detectee : '. $error);
            ...
            if ($this->Educazad_model->update_data('tb_am_users', $user_data, array('id_asset' => $this->session->id))) {
