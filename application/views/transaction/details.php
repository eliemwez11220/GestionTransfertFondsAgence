    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Details Transaction</h3>
              	<div class="box-tools">
				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="transac_monnaie" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="transac_type" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="provenance" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="destination" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="client_sid" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="beneficiaire_sid" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="agent_sid" class="form-control" readonly>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="transac_montant" value="<?php echo ($this->input->post('transac_montant') ? $this->input->post('transac_montant') : $tb_am_transaction['transac_montant']); ?>" class="form-control" id="transac_montant"readonly />
						</div>
					</div>
					<div class="col-md-6">
						<label for="transac_pourc" class="control-label">Transac Pourc</label>
						<div class="form-group">
							<input type="text" name="transac_pourc" value="<?php echo ($this->input->post('transac_pourc') ? $this->input->post('transac_pourc') : $tb_am_transaction['transac_pourc']); ?>" class="form-control" id="transac_pourc" readonly/>
						</div>
					</div>
					<div class="col-md-6">
						<label for="transac_taux" class="control-label">Transac Taux</label>
						<div class="form-group">
							<input type="text" name="transac_taux" value="<?php echo ($this->input->post('transac_taux') ? $this->input->post('transac_taux') : $tb_am_transaction['transac_taux']); ?>" class="form-control" id="transac_taux" readonly/>
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="montant_caisse" value="<?php echo ($this->input->post('montant_caisse') ? $this->input->post('montant_caisse') : $tb_am_transaction['montant_caisse']); ?>" class="form-control" id="montant_caisse" readonly/>
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_created" value="<?php echo ($this->input->post('date_created') ? $this->input->post('date_created') : $tb_am_transaction['date_created']); ?>" class="form-control" id="date_created" readonly/>
						</div>
					</div>
					<div class="col-md-6">
						<label for="date_retrait" class="control-label">Date de retrait</label>
						<div class="form-group">
							<input type="text" name="date_retrait" value="<?php echo ($this->input->post('date_retrait') ? $this->input->post('date_retrait') : $tb_am_transaction['date_retrait']); ?>" class="form-control" id="date_retrait" readonly />
						</div>
					</div>
				</div>
			</div>
