        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">CashMoney</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">CashMoney</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-cubes"></i> <span>Agence</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('agence/add');?>"><i class="fa fa-plus"></i> Creer une agence</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('agence/index');?>"><i class="fa fa-list-ul"></i> Listing agences</a>
                                </li>
							</ul>
                        </li>
						<li>
                            <a href="#">
                                <i class="fa fa-address-card"></i> <span>Bons</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('bons/add');?>"><i class="fa fa-plus"></i> Creer bon</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('bons/index');?>"><i class="fa fa-list-ul"></i> Listing bons</a>
                                </li>
							</ul>
                        </li>
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('client/add');?>"><i class="fa fa-plus"></i> Creer un client</a>
                                </li>
								<li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-binoculars"></i> <span>Transaction</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('transaction/add');?>"><i class="fa fa-plus"></i> Creer une transaction</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('transaction/index');?>"><i class="fa fa-list-ul"></i> Listing transactions</a>
                                </li>

                                <li>
                                    <a href="<?php echo site_url('transaction/retrait');?>"><i class="fa fa-list-ul"></i> Retrait argents</a>
                                </li>
